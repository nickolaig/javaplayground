...
@Component
public class TamagotchiTicklePlugin implements PlaygroundPlugin {
	...
	@Autowired
	public  TamagotchiTicklePlugin(UserService users,ElementService elements) {
	...
	public Object invokeOperation(ActivityEntity activity, ElementEntity element, UserEntity user) throws Exception {
		...
		element.setJsonAttributes(jackson.writeValueAsString(value));	
